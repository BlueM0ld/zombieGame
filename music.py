...
authenticator = IAMAuthenticator(
    '9e2rg8T3by_sBIu3SbyCFWZkQLzCHGBfZUHYx0s4U8E3')
tone_analyzer = ToneAnalyzerV3(
    version='2017-09-21',
    authenticator=authenticator
)
tone_analyzer.set_service_url(
    'https://api.eu-gb.tone-analyzer.watson.cloud.ibm.com/instances/3806638c-85e1-4670-9013-4e303338e90a')
...
class ToneMusic:
    ...
    def run(self):
        ...
        if tone == "confident":
            ...
            path = os.path.join(root_dir, "AI_game", "music", "death.wav")

        if(flag == False or tone == "ending"):
